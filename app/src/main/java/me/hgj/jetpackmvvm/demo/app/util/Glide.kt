...
import me.hgj.jetpackmvvm.demo.Constants
import java.io.File
...
@JvmSynthetic
fun ImageView.loadAppIcon(
    string: String?,
    transitionOptions: TransitionOptions<*, Drawable>? = null,
    requestOptions: RequestOptions? = null
): ViewTarget<ImageView, Drawable> = loadAny(Constants.IMAGE_BASE_URL+string, transitionOptions, requestOptions)
@JvmSynthetic
fun ImageView.load(
    file: File?,
    transitionOptions: TransitionOptions<*, Drawable>? = null,
